  ...
  return (
    <figure className={className} aria-label={ariaLabel} role="img">
      ...
      >
        ...
        <rect width="880" height="400" fill="url(#bg-grad)" rx="8" />
        <rect width="880" height="400" fill="url(#subtle-grid)" opacity="0.3" rx="8" />
        ...
        <g className="pipeline-flow">
          ...
          {PIPELINE_STAGES.map((label, i) => {
            const x = 90 + i * 110;
            return (
              <g key={label} className="pipe-stage" transform={`translate(${x}, 35)`}>
                <circle
          ...
          <g id="pipeline-signal">
            <circle cx="90" cy="35" r="4" fill="url(#signal-grad)" filter="url(#strong-glow)" />
            <circle cx="90" cy="35" r="7" fill="none" stroke="url(#signal-grad)" strokeWidth="1.5" opacity="0.4" />
          </g>
        </g>

        {/* LEFT: BVH Skeleton */}
        <g transform="translate(130, 200)" id="bvh-skeleton">
          <text x="0" y="-120" textAnchor="middle" fontFamily="var(--font-mono)" fontSize="9.5" fontWeight={600} fill="#c6a15b">BVH INPUT SKELETON</text>
        ...
        <g transform="translate(440, 200)">
          <text x="0" y="-120" textAnchor="middle" fontFamily="var(--font-mono)" fontSize="9.5" fontWeight={600} fill="#a51c30">COORD TRANSFORM CORE</text>
        ...
        <g transform="translate(750, 200)" id="smplh-skeleton">
          <text x="0" y="-120" textAnchor="middle" fontFamily="var(--font-mono)" fontSize="9.5" fontWeight={600} fill="#22c55e">SMPL-H OUTPUT</text>
        ...
        {/* Bottom metrics */}
        <g transform="translate(440, 325)" textAnchor="middle">
          ...
          <text x="180" y="0" fontFamily="var(--font-mono)" fontSize="15" fontWeight={700} fill="#e5e7eb">3 EXPORTS</text>
          <text x="180" y="14" fontFamily="var(--font-sans)" fontSize="7.5" fontWeight={500} fill="#6b7280" letterSpacing="0.08em">NPZ · BVH · MP4</text>
        </g>

        <g transform="translate(440, 365)" textAnchor="middle">
