...
export function MotionProcessingDiagram({
  className = "",
  "aria-label": ariaLabel = "BVH to SMPL-H motion processing pipeline architecture blueprint",
  ...
  return (
    <figure className={`w-full overflow-hidden ${className}`} aria-label={ariaLabel} role="img">
      ...
      >
        ...
        <rect width="1000" height="520" fill="#0B0C0E" rx="8" />
        <rect width="1000" height="520" fill="url(#grid)" opacity="0.35" rx="8" />
        <rect width="1000" height="520" fill="none" stroke="#1A1A20" strokeWidth="1" rx="8" />

        {/* Top Title Bar */}
        <g transform="translate(40, 25)">
          <circle cx="6" cy="6" r="4" fill="#C6A15B" filter="url(#glow)" />
          <text x="18" y="9" fontFamily="var(--font-mono)" fontSize="11" fontWeight="600" fill="#C6A15B" letterSpacing="0.08em">
            MOTION PROCESSING PIPELINE · BVH TO SMPL-H KINEMATIC RECONSTRUCTION
          </text>
        </g>

        {/* Pipeline flow arrows */}
        <g stroke="#80633A" strokeWidth="1.5" fill="none" markerEnd="url(#arrow)">
          <path d="M160 95 L200 95" />
          <path d="M320 95 L360 95" />
          <path d="M480 95 L520 95" />
          <path d="M640 95 L680 95" />
          <path d="M800 95 L840 95" />
        </g>
        ...
        <g transform="translate(520, 45)">
          <rect x="0" y="0" width="120" height="100" rx="4" fill="#07080A" stroke="#A51C30" strokeWidth="1.5" />
        ...
        <g transform="translate(680, 45)">
          <rect x="0" y="0" width="120" height="100" rx="4" fill="#07080A" stroke="#2D7D46" strokeWidth="1.5" />
        ...
        {/* Technical Details Section - Skeletal Hierarchy (y = 175) */}
        <g transform="translate(40, 175)">
          <rect x="0" y="0" width="280" height="165" rx="4" fill="#07080A" stroke="#1A1A20" strokeWidth="1" />
        ...
        {/* Coordinate Frame Visualization (y = 175) */}
        <g transform="translate(340, 175)">
          <rect x="0" y="0" width="320" height="165" rx="4" fill="#07080A" stroke="#1A1A20" strokeWidth="1" />
        ...
        {/* Grounding & Stabilization Modules (y = 360) */}
        <g transform="translate(40, 360)">
          <g transform="translate(0, 0)">
            <rect x="0" y="0" width="280" height="52" rx="4" fill="#07080A" stroke="#80633A" strokeWidth="1" />
            <text x="140" y="22" textAnchor="middle" fontFamily="var(--font-mono)" fontSize="9" fontWeight="600" fill="#C6A15B">GROUNDING</text>
            <text x="140" y="37" textAnchor="middle" fontFamily="var(--font-mono)" fontSize="8" fill="#85858A">Percentile Floor Detection</text>
          </g>

          <g transform="translate(300, 0)">
            <rect x="0" y="0" width="320" height="52" rx="4" fill="#07080A" stroke="#A51C30" strokeWidth="1" />
            <text x="160" y="22" textAnchor="middle" fontFamily="var(--font-mono)" fontSize="9" fontWeight="600" fill="#A51C30">FOOT LOCK STABILIZATION</text>
            <text x="160" y="37" textAnchor="middle" fontFamily="var(--font-mono)" fontSize="8" fill="#85858A">Translation-Only Deterministic Lock</text>
          </g>

          <g transform="translate(640, 0)">
            <rect x="0" y="0" width="280" height="52" rx="4" fill="#07080A" stroke="#2D7D46" strokeWidth="1" />
            <text x="140" y="22" textAnchor="middle" fontFamily="var(--font-mono)" fontSize="9" fontWeight="600" fill="#2D7D46">SAVITZKY-GOLAY SMOOTHING</text>
            <text x="140" y="37" textAnchor="middle" fontFamily="var(--font-mono)" fontSize="8" fill="#85858A">Window = 11, Poly = 3 Filter</text>
          </g>
        </g>

        {/* Bottom Bar: Export Formats & Stack (y = 480) */}
