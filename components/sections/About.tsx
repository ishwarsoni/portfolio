    ...
    >
      <Container size="narrow">
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-start">
          <blockquote ref={quoteRef} className="relative pl-8 border-l-2 border-burnished-bronze/30">
            <Typography variant="lead" className="text-ivory">
              &ldquo;{aboutData.quote}&rdquo;
            </Typography>
          </blockquote>

          <ul ref={principlesRef} className="space-y-4" role="list" aria-label="Engineering principles">
            {aboutData.principles.map((principle, index) => (
              <li key={index} className="flex items-start gap-4 text-ash font-sans leading-relaxed">
        ...
        <Divider variant="gold" className="my-12 max-w-md mx-auto" />
