...
export default function WarpField() {
    ...
    useEffect(() => {
        ...
        // Configuration - Yahan se speed control hogi
        const STAR_COUNT = 1000; // Kitne tare honge
        const BASE_SPEED = 15; // Normal speed
        const BOOST_SPEED = 35; // Mouse move/scroll par speed boost
        ...
        class Star {
            ...
            draw() {
                ...
                // Mouse influence on vanishing point (Steering effect)
                const offsetX = (mouseX - width / 2) * (scale * 0.05);
                const offsetY = (mouseY - height / 2) * (scale * 0.05);
